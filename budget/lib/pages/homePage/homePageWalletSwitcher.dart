        ...
        Widget child = Column(
          children: [
            if (allWalletsPks.length <= 0)
              NoResultsCreate(
                message: "حسابی پیدا نشد",
                buttonLabel: "ساخت حساب",
                route: AddWalletPage(
            ...
            if (homePageWidgetDisplay == HomePageWidgetDisplay.WalletList &&
              ...
              HorizontalBreakAbove(
                ...
                child: SettingsContainerSwitch(
                  ...
                  onSwitched: (value) {
                    updateSettings("walletsListCurrencyBreakdown", value, updateGlobalState: false, pagesNeedingRefresh: [1]);
                  },
