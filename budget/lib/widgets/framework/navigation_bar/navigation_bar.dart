    ...
    return _NavigationDestinationBuilder(
      ...
      buildLabel: (BuildContext context) {
        final TextStyle? effectiveSelectedLabelTextStyle =
            navigationBarTheme.labelTextStyle?.resolve(selectedState)!.copyWith(fontFamily: 'Sans') ??
                defaults.labelTextStyle!.resolve(selectedState)!.copyWith(fontFamily: 'Sans');
        final TextStyle? effectiveUnselectedLabelTextStyle =
            navigationBarTheme.labelTextStyle?.resolve(unselectedState)!.copyWith(fontFamily: 'Sans') ??
                defaults.labelTextStyle!.resolve(unselectedState)!.copyWith(fontFamily: 'Sans');
        return Padding(
          padding:
              EdgeInsets.only(top: 4, left: _isForwardOrCompleted(animation) ? 0 : 3, right: _isForwardOrCompleted(animation) ? 0 : 3),
          child: _ClampTextScaleFactor(
            ...
            child: Text(
              ...
              style: _isForwardOrCompleted(animation) ? effectiveSelectedLabelTextStyle : effectiveUnselectedLabelTextStyle,
            ),
          ),
        );
      },
...
class _NavigationBarDefaultsM2 extends NavigationBarThemeData {
  ...
  MaterialStateProperty<TextStyle?>? get labelTextStyle =>
      MaterialStatePropertyAll<TextStyle?>(_theme.textTheme.labelSmall!.copyWith(color: _colors.onSurface, fontFamily: 'Sans'));
}
...
class _NavigationBarDefaultsM3 extends NavigationBarThemeData {
  ...
  MaterialStateProperty<TextStyle?>? get labelTextStyle {
    return MaterialStateProperty.resolveWith((Set<MaterialState> states) {
      ...
      return style.apply(
          color: states.contains(MaterialState.selected) ? _colors.onSurface : _colors.onSurfaceVariant, fontFamily: 'Sans');
    });
  }
}
