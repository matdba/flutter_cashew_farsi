          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                if (title != null || underTitleSpace == true) SizedBox(height: 13),
                Padding(
                  padding: hasPadding ? EdgeInsets.symmetric(horizontal: 18) : EdgeInsets.zero,
                  child: child,
                ),
            ...
            child: Row(
              ...
              children: [
                if (outsideExtraWidget != null)
                  Transform.translate(
                    offset: Offset((getIsFullScreen(context) || showCloseButton) ? 20 : 0, 0),
                ...
                if (getIsFullScreen(context) || showCloseButton)
                  IconButton(
                    ...
                    icon: Icon(
                      appStateSettings["outlinedIcons"] ? Icons.close_outlined : Icons.close_rounded,
                    ),
                    onPressed: () {
