...
class _DayHeaders extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle textStyle = themeData.textTheme.labelLarge!.apply(color: colorScheme.onSurface, fontFamily: 'SansFaNum');
...
class _MonthItemState extends State<_MonthItem> {
  ...
  void initState() {
    ...
    _dayFocusNodes =
        List<FocusNode>.generate(daysInMonth, (int index) => FocusNode(skipTraversal: true, debugLabel: 'Day ${index + 1}'));
  }
  ...
  Widget _buildDayItem(BuildContext context, Jalali dayToBuild, int firstDayOffset, int daysInMonth) {
    ...
    TextStyle? itemStyle = textTheme.bodyMedium!.apply(fontFamily: 'SansFaNum');
    ...
    if (isSelectedDayStart || isSelectedDayEnd) {
      ...
      itemStyle = textTheme.bodyMedium?.apply(color: colorScheme.onPrimary, fontFamily: 'SansFaNum');
      ...
      itemStyle = textTheme.bodyMedium?.apply(color: colorScheme.onSurface.withOpacity(0.38), fontFamily: 'SansFaNum');
    } else if (utils.isSameDay(widget.currentDate, dayToBuild)) {
      // The current day gets a different text color and a circle stroke
      // border.
      itemStyle = textTheme.bodyMedium?.apply(color: colorScheme.primary, fontFamily: 'SansFaNum');
      decoration = BoxDecoration(
        ...
        Container(
          ...
          child: ExcludeSemantics(
            child: Text(
              ...
              style: textTheme.bodyMedium!.apply(color: themeData.colorScheme.onSurface, fontFamily: 'SansFaNum'),
            ),
          ),
        ),
        Container(
