...
///
Future<JalaliRange?> showPersianDateRangePickerCustom({
...
class _CalendarRangePickerDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color headerForeground = Theme.of(context).colorScheme.onSecondaryContainer;
    ...
    final TextStyle? headlineStyle = textTheme.titleLarge!.apply(fontFamily: 'SansFaNum');
