...
const Size _calendarPortraitDialogSize = Size(400.0, 580.0);
...
/// must be non-null.
Future<Jalali?> showPersianDatePickerCustom({
...
class _DatePickerDialogState extends State<_DatePickerDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final String dateText = _selectedDate != null
        ...
        : 'Date';
    final Color dateColor = Theme.of(context).colorScheme.onBackground;
    final TextStyle? dateStyle = orientation == Orientation.landscape
        ? textTheme.titleLarge?.copyWith(color: dateColor, fontWeight: FontWeight.bold, fontFamily: 'SansFaNum')
        : textTheme.headlineSmall?.copyWith(color: dateColor, fontWeight: FontWeight.bold, fontFamily: 'SansFaNum');
    ...
    return Dialog(
      ...
      shape: dialogTheme.shape ?? const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(32.0))),
