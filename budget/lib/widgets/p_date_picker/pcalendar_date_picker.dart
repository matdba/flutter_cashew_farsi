...
const double _dayPickerPortraitRowHeight = 50.0;
const double _dayPickerLandscapeRowHeight = 28.0;
const int _maxDayPickerRowCount = 6; // A 31 day month that starts on Saturday.
// One extra row for the day-of-week header.
const double _maxDayPickerHeight = _dayPickerPortraitRowHeight * (_maxDayPickerRowCount + 1);
...
class PCalendarDatePicker extends StatefulWidget {
  ...
  PCalendarDatePicker({
    ...
    assert(
        !this.initialDate.isAfter(this.lastDate), 'initialDate ${this.initialDate} must be on or before lastDate ${this.lastDate}.');
...
class _CalendarDatePickerState extends State<PCalendarDatePicker> {
  ...
  void initState() {
    ...
    _currentDisplayedMonthDate = Jalali(widget.initialDate.year, widget.initialDate.month);
      ...
      children: <Widget>[
        ...
        _DatePickerModeToggleButton(
          ...
          onTitlePressed: () {
            ...
            _handleModeChanged(_mode == PDatePickerMode.day ? PDatePickerMode.year : PDatePickerMode.day);
          },
        ),
      ],
    );
...
class _DayPicker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final ColorScheme colorScheme = Theme.of(context).colorScheme;
    final TextTheme textTheme = Theme.of(context).textTheme;
    final TextStyle? dayStyle = textTheme.bodyMedium!.apply(fontFamily: 'SansFaNum');
    ...
    return Padding(
      ...
      child: GridView.custom(
        ...
        gridDelegate: MediaQuery.of(context).orientation == Orientation.portrait
            ? _dayPickerGridDelegatePortrait
            : _dayPickerGridDelegateLandscape,
...
class _DayPickerGridDelegatePortrait extends SliverGridDelegate {
  const _DayPickerGridDelegatePortrait();

  @override
  SliverGridLayout getLayout(SliverConstraints constraints) {
    const int columnCount = JalaliDate.daysPerWeek;
    final double tileWidth = constraints.crossAxisExtent / columnCount;
    final double tileHeight = math.min(_dayPickerPortraitRowHeight, constraints.viewportMainAxisExtent / _maxDayPickerRowCount);
  ...
  @override
  bool shouldRelayout(_DayPickerGridDelegatePortrait oldDelegate) => false;
}

const _DayPickerGridDelegatePortrait _dayPickerGridDelegatePortrait = _DayPickerGridDelegatePortrait();

class _DayPickerGridDelegateLandscape extends SliverGridDelegate {
  const _DayPickerGridDelegateLandscape();

  @override
  SliverGridLayout getLayout(SliverConstraints constraints) {
    const int columnCount = JalaliDate.daysPerWeek;
    final double tileWidth = constraints.crossAxisExtent / columnCount;
    final double tileHeight = math.min(_dayPickerLandscapeRowHeight, constraints.viewportMainAxisExtent / _maxDayPickerRowCount);
    return SliverGridRegularTileLayout(
      childCrossAxisExtent: tileWidth,
      childMainAxisExtent: tileHeight,
      crossAxisCount: columnCount,
  ...
  @override
  bool shouldRelayout(_DayPickerGridDelegateLandscape oldDelegate) => false;
}

const _DayPickerGridDelegateLandscape _dayPickerGridDelegateLandscape = _DayPickerGridDelegateLandscape();
...
class _DayHeaders extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle? dayHeaderStyle = theme.textTheme.bodyLarge?.apply(
...
class _YearPickerState extends State<_YearPicker> {
  ...
  Widget _buildYearItem(BuildContext context, int index) {
    ...
    final TextStyle? itemStyle = textTheme.bodyLarge?.apply(color: textColor, fontFamily: 'SansFaNum');
